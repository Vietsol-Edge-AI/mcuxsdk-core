...
foreach(image ${IMAGES})
  ...
  if(TARGET ${image}_cache)
    get_property(tmp_core_id TARGET ${image}_cache PROPERTY core_id)
    # core_id is not set for single core devices, so we only add it if present(for multicore devices)
    if(tmp_core_id)
      set(domains_yaml "${domains_yaml}\n    core_id: ${tmp_core_id}")
    endif()
  else()
    message(STATUS "${image}_cache target is not found, can not get core_id.")
  endif()
endforeach()
set(domains_yaml "${domains_yaml}\nflash_order:")
